...
# 1. Chuẩn bị môi trường và triển khai các service
...
### 4.2.8. Kiểm tra reverse proxy bằng Terminal
...
### 5.2.1. Cho container Node-RED đọc file .env
